...
const baseTheme = {
  ...
  navigation: {
    tabStation: 'standard',
    aero: {
      stationTop: 'rgba(255,255,255,0.97)',
      stationBottom: 'rgba(224,247,255,0.96)',
      stationBorder: 'rgba(255,255,255,0.96)',
      stationShadow: '#74B6D4',
      grassLight: '#D8F3A8',
      grassMid: '#9FDC73',
      grassDark: '#6DBA61',
      grassBlade: '#72C665',
      orbTop: 'rgba(255,255,255,0.92)',
      orbBottom: 'rgba(232,248,255,0.88)',
      orbBorder: 'rgba(255,255,255,0.90)',
      orbSelectedTop: '#FFFFFF',
      orbSelectedBottom: '#DDF4FF',
      selectedBorder: 'rgba(77,185,229,0.72)',
      selectedGlow: '#58BFE7',
      iconInk: '#0A1222',
      labelActive: '#0A1222',
      labelInactive: '#5E7180',
    },
  },
};
