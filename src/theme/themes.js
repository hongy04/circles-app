...
const baseTheme = {
  ...
  navigation: {
    tabStation: 'aero-grass',
    aero: {
      stationTop: 'rgba(255,255,255,0.96)',
      stationBottom: 'rgba(232,234,238,0.94)',
      stationBorder: 'rgba(255,255,255,0.92)',
      stationShadow: '#7E8792',
      grassLight: '#F7F7F8',
      grassMid: '#C9CDD2',
      grassDark: '#767E88',
      grassBlade: '#989FA7',
      orbTop: 'rgba(255,255,255,0.96)',
      orbBottom: 'rgba(225,228,233,0.92)',
      orbBorder: 'rgba(255,255,255,0.90)',
      orbSelectedTop: '#FFFFFF',
      orbSelectedBottom: '#DDE1E6',
      selectedBorder: 'rgba(10,18,34,0.60)',
      selectedGlow: '#8A929D',
      iconInk: '#0A1222',
      labelActive: '#0A1222',
      labelInactive: '#606770',
    },
  },
};
...
export const THEME_IDS = {
  ...
  MIDNIGHT_HARBOR: 'midnight-harbor',
};
...
export const THEME_REGISTRY = {
  [THEME_IDS.DEFAULT]: createTheme({
    ...
    name: 'Default',
    description: 'The clean Circles interface with a monochrome Frutiger Aero glass dock.',
  }),
  [THEME_IDS.AQUA_DAYLIGHT]: createTheme({
    ...
    overrides: {
      ...
      navigation: {
        tabStation: 'aero-grass',
        aero: {
          stationTop: 'rgba(255,255,255,0.98)',
          stationBottom: 'rgba(220,246,255,0.96)',
          stationBorder: 'rgba(255,255,255,0.98)',
          stationShadow: '#73BDD9',
          grassLight: '#DDF6AF',
          grassMid: '#A6E17B',
          grassDark: '#70BE64',
          grassBlade: '#79C96A',
          orbTop: 'rgba(255,255,255,0.96)',
          orbBottom: 'rgba(225,246,255,0.94)',
          orbSelectedTop: '#FFFFFF',
          orbSelectedBottom: '#D7F1FF',
          selectedBorder: 'rgba(77,185,229,0.74)',
          selectedGlow: '#58BFE7',
          iconInk: '#0A1222',
          labelActive: '#0A1222',
          labelInactive: '#597080',
        },
      },
    },
  }),
  [THEME_IDS.CITRUS_GARDEN]: createTheme({
    ...
    overrides: {
      ...
      navigation: {
        tabStation: 'aero-grass',
        aero: {
          stationTop: 'rgba(255,255,250,0.98)',
          stationBottom: 'rgba(241,251,217,0.97)',
          stationBorder: 'rgba(255,255,255,0.98)',
          stationShadow: '#B8D97C',
          grassLight: '#F2E982',
          grassMid: '#BDE45D',
          grassDark: '#79C96B',
          grassBlade: '#8ED46E',
          orbTop: 'rgba(255,255,255,0.96)',
          orbBottom: 'rgba(244,251,221,0.94)',
          orbSelectedTop: '#FFFFFF',
          orbSelectedBottom: '#ECF8C9',
          selectedBorder: 'rgba(116,201,110,0.76)',
          selectedGlow: '#A8D95F',
          iconInk: '#173021',
          labelActive: '#173021',
          labelInactive: '#687B5D',
        },
      },
    },
  }),
  [THEME_IDS.BUBBLEGUM_SKY]: createTheme({
    ...
    overrides: {
      ...
      navigation: {
        ...
        aero: {
          stationTop: 'rgba(255,255,255,0.98)',
          stationBottom: 'rgba(245,235,255,0.97)',
          stationBorder: 'rgba(255,255,255,0.98)',
          stationShadow: '#C8B2E8',
          grassLight: '#F5B8DD',
          grassMid: '#B8A8F4',
          grassDark: '#71D6D2',
          grassBlade: '#A69EEA',
          orbTop: 'rgba(255,255,255,0.97)',
          orbBottom: 'rgba(239,244,255,0.95)',
          orbSelectedTop: '#FFFFFF',
          orbSelectedBottom: '#F2E9FF',
          selectedBorder: 'rgba(138,141,235,0.76)',
          selectedGlow: '#D59BD8',
          iconInk: '#171A37',
          labelActive: '#171A37',
          labelInactive: '#77718D',
        },
      },
    },
  }),
  [THEME_IDS.AFTER_RAIN]: createTheme({
    ...
    overrides: {
      ...
      navigation: {
        tabStation: 'aero-grass',
        aero: {
          stationTop: 'rgba(248,252,253,0.98)',
          stationBottom: 'rgba(221,236,243,0.97)',
          stationBorder: 'rgba(255,255,255,0.94)',
          stationShadow: '#86ACBD',
          grassLight: '#A7D7D8',
          grassMid: '#76B8C7',
          grassDark: '#7279A6',
          grassBlade: '#6EB2C2',
          orbTop: 'rgba(252,254,255,0.96)',
          orbBottom: 'rgba(226,240,245,0.94)',
          orbSelectedTop: '#FFFFFF',
          orbSelectedBottom: '#D9EDF3',
          selectedBorder: 'rgba(63,159,197,0.76)',
          selectedGlow: '#5AAFC9',
          iconInk: '#102333',
          labelActive: '#102333',
          labelInactive: '#657784',
        },
      },
    },
  }),
  [THEME_IDS.SUNSET_CORAL]: createTheme({
    id: THEME_IDS.SUNSET_CORAL,
    name: 'Sunset Coral',
    description: 'Warm orange-red glass, peach light, and a late-summer glow.',
    overrides: {
      fluid: {
        particle: '#F16F52',
        boundaryRipple: 'rgba(241,111,82,0.72)',
        shadow: '#E89A79',
      },
      circle: {
        accent: '#EE674C',
        accentSoft: '#FFE1D6',
        profileBackground: '#FFFBF8',
        headerGradient: ['#FFF8F2', '#FFE7DC'],
        decalPalette: ['#F16F52', '#FF9B57', '#E94E63', '#FFC66D', '#D95B76'],
      },
      navigation: {
        tabStation: 'aero-grass',
        aero: {
          stationTop: 'rgba(255,252,249,0.98)',
          stationBottom: 'rgba(255,226,211,0.96)',
          stationBorder: 'rgba(255,255,255,0.96)',
          stationShadow: '#DFA08B',
          grassLight: '#FFD08A',
          grassMid: '#FF956A',
          grassDark: '#D85A57',
          grassBlade: '#ED745C',
          orbTop: 'rgba(255,255,255,0.96)',
          orbBottom: 'rgba(255,232,221,0.94)',
          orbSelectedTop: '#FFFFFF',
          orbSelectedBottom: '#FFDACC',
          selectedBorder: 'rgba(238,103,76,0.74)',
          selectedGlow: '#F08A6A',
          iconInk: '#3A1715',
          labelActive: '#3A1715',
          labelInactive: '#8A625B',
        },
      },
    },
  }),
  [THEME_IDS.MIDNIGHT_HARBOR]: createTheme({
    id: THEME_IDS.MIDNIGHT_HARBOR,
    name: 'Midnight Harbor',
    description: 'Dark navy glass with moonlit blue, silver, and cool aqua accents.',
    overrides: {
      colors: {
        bg: '#F5F8FC',
        text: '#0A1730',
      ...
      fluid: {
        particle: '#285A8E',
        boundaryRipple: 'rgba(40,90,142,0.72)',
        shadow: '#557DA4',
      },
      circle: {
        accent: '#173F6B',
        accentSoft: '#DCE8F3',
        profileBackground: '#F5F8FC',
        headerGradient: ['#F5F8FC', '#DCE8F3'],
        decalPalette: ['#102A43', '#245B8E', '#4FA3C7', '#7B8FA8', '#B8CADB'],
      },
      navigation: {
        tabStation: 'aero-grass',
        aero: {
          stationTop: 'rgba(247,251,255,0.97)',
          stationBottom: 'rgba(202,218,233,0.95)',
          stationBorder: 'rgba(255,255,255,0.90)',
          stationShadow: '#55718E',
          grassLight: '#B9D5E7',
          grassMid: '#5B87A8',
          grassDark: '#173F6B',
          grassBlade: '#3F6F94',
          orbTop: 'rgba(255,255,255,0.95)',
          orbBottom: 'rgba(210,226,239,0.92)',
          orbSelectedTop: '#FFFFFF',
          orbSelectedBottom: '#CADCEB',
          selectedBorder: 'rgba(23,63,107,0.74)',
          selectedGlow: '#4D7FA8',
          iconInk: '#09182A',
          labelActive: '#09182A',
          labelInactive: '#5B6E82',
        },
      },
    },
  }),
