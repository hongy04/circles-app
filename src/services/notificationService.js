...
function mapNotification(row) {
  ...
  return {
    ...
    twoPersonPlanId: row.two_person_plan_id || null,
    twoPersonThoughtId: row.two_person_thought_id || null,
    targetTitle: row.target_title || null,
    safetyReportId: row.safety_report_id || null,
    accountAppealId: row.account_appeal_id || null,
    ageCorrectionRequestId: row.age_correction_request_id || null,
