      ...
      <SafeAreaView edges={['top']} style={themedStyles.safeArea}>
        ...
        >
          ...
          <Text style={themedStyles.subtitle}>
            ...
            temporary and reset to Aqua Daylight when the app reloads.
          </Text>
          ...
          <View style={themedStyles.noteCard}>
            ...
            <Text style={themedStyles.noteText}>
              ...
              preference, update Supabase, or change Circle permissions. A real
              theme picker comes after we approve the visual directions.
            </Text>
          </View>
        </ScrollView>
      </SafeAreaView>
